...
// Define the SocialIcon component
...
const SocialIcon = ({ children, href }: SocialIconProps) => (
    <a 
        ...
        className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center text-gray-500 hover:bg-[#1479ae] hover:text-white transition-all duration-300"
    >
        {children}
    </a>
);
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-gray-600">
                        ...
                        <li className="flex items-start">
                            ...
                            <a href="mailto:info@iconic.com" className="hover:text-[#1479ae]">info@iconic.com</a>
                        </li>
                        <li className="flex items-start">
                            ...
                            <div>
                                ...
                                <a href="tel:+919629466826" className="block hover:text-[#1479ae]">+91 96294 66826</a>
                            </div>
                        </li>
                    </ul>
                </div>
